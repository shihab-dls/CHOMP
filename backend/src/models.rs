...
impl From<Metadata> for soakdb::models::Metadata {
...
impl From<soakdb::models::MetadataReadback> for MetadataReadback {
    fn from(value: soakdb::models::MetadataReadback) -> Self {
        Self {
            name: value.name,
            protein: value.protein,
        }
...
impl From<Visit> for soakdb::models::Visit {
...
impl From<Crystal> for soakdb::models::Crystal {
...
impl From<Position> for soakdb::models::Position {
...
impl From<Solvent> for soakdb::models::Solvent {
...
impl From<Cryo> for soakdb::models::Cryo {
...
impl From<Mount> for soakdb::models::Mount {
...
impl From<Status> for soakdb::models::Status {
...
impl From<soakdb::models::Status> for Status {
    fn from(value: soakdb::models::Status) -> Self {
        match value {
            soakdb::models::Status::Success => Self::Success,
            soakdb::models::Status::Failure => Self::Failure,
            soakdb::models::Status::Pending => Self::Pending,
        }
    }
}
...
impl From<MountingResult> for soakdb::models::MountingResult {
...
impl From<ISPyBExport> for soakdb::models::ISPyBExport {
...
impl From<soakdb::models::ISPyBExport> for ISPyBExport {
    fn from(value: soakdb::models::ISPyBExport) -> Self {
        match value {
            soakdb::models::ISPyBExport::Exported => Self::Exported,
            soakdb::models::ISPyBExport::Pending => Self::Pending,
        }
    }
}

impl From<Well> for soakdb::models::Well {
...
impl From<soakdb::models::WellReadback> for WellReadback {
    fn from(value: soakdb::models::WellReadback) -> Self {
        Self {
            id: value.id,
...
impl From<soakdb::models::Visit> for VisitReadback {
    fn from(value: soakdb::models::Visit) -> Self {
        Self {
            proposal_type: value.proposal_type,
            proposal_number: value.proposal_number,
            visit_number: value.visit_number,
...
impl From<soakdb::models::CrystalReadback> for CrystalReadback {
    fn from(value: soakdb::models::CrystalReadback) -> Self {
        Self {
...
impl From<soakdb::models::Position> for PositionReadback {
    fn from(value: soakdb::models::Position) -> Self {
        Self {
            x: value.x,
            y: value.y,
        }
...
impl From<soakdb::models::SolventReadback> for SolventReadback {
    fn from(value: soakdb::models::SolventReadback) -> Self {
        Self {
            plate: into_parsing_error(value.plate),
            well: into_parsing_error(value.well),
            name: into_parsing_error(value.name),
...
impl From<soakdb::models::CryoReadback> for CryoReadback {
    fn from(value: soakdb::models::CryoReadback) -> Self {
        Self {
            well: into_parsing_error(value.well),
...
impl From<soakdb::models::MountReadback> for MountReadback {
    fn from(value: soakdb::models::MountReadback) -> Self {
        Self {
...
impl From<soakdb::models::MountingResult> for MountingResultReadback {
    fn from(value: soakdb::models::MountingResult) -> Self {
        Self {
            success: value.success,
            comment_1: value.comment_1,
            comment_2: value.comment_2,
